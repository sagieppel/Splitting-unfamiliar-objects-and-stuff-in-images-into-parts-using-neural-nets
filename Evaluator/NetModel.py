#
#  Evaluator net
#  evaluator for parts of object a resnet receive object mask image and a part mask and evaluate and image how good this part match real part of the object in term IOU
#
...
###############################################Run prediction inference using the net ###########################################################################################################
        def forward(self,Images,Segment,ROI,UseGPU=True,TrainMode=True):
                if TrainMode:
