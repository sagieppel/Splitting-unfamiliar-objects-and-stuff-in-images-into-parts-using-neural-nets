...
1. Download ADE20k from [here](https://deepai.org/dataset/ade20k) or [here](https://icedrive.net/0/573y9eCWuI) note that the reader only work with the older  (2016) version of the dataset
